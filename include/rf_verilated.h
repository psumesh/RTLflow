...
using WData = IData;        ///< Data representing >64 packed bits (used as pointer)
...
__device__ __host__ static inline WDataOutP VL_EXTENDS_WW(int obits, int lbits, WDataOutP owp,
                                                          WDataInP lwp) VL_MT_SAFE {
...
__device__ __host__ static inline IData VL_REDXOR_2(IData r) VL_PURE {
    // Experiments show VL_REDXOR_2 is faster than __builtin_parityl
    r = (r ^ (r >> 1));
    return r;
}

__device__ __host__ static inline IData VL_REDXOR_4(IData r) VL_PURE {
...
__device__ __host__ static inline IData VL_REDXOR_8(IData r) VL_PURE {
    //#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    // return __builtin_parityl(r);
    //#else
    r = (r ^ (r >> 1));
...
__device__ __host__ static inline IData VL_REDXOR_16(IData r) VL_PURE {
    //#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    // return __builtin_parityl(r);
    //#else
    r = (r ^ (r >> 1));
...
__device__ __host__ static inline IData VL_REDXOR_32(IData r) VL_PURE {
    //#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    // return __builtin_parityl(r);
    //#else
    r = (r ^ (r >> 1));
...
__device__ __host__ static inline IData VL_REDXOR_64(QData r) VL_PURE {
    //#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
...
__device__ __host__ static inline IData VL_GTS_III(int, int lbits, int, IData lhs,
                                                   IData rhs) VL_PURE {
...
__device__ __host__ static inline IData VL_GTS_IQQ(int, int lbits, int, QData lhs,
                                                   QData rhs) VL_PURE {
...
__device__ __host__ static inline IData VL_GTES_III(int, int lbits, int, IData lhs,
                                                    IData rhs) VL_PURE {
    vlsint64_t lhs_signed = VL_EXTENDS_QQ(64, lbits, lhs);  // Q for gcc
    vlsint64_t rhs_signed = VL_EXTENDS_QQ(64, lbits, rhs);  // Q for gcc
    return lhs_signed >= rhs_signed;
...
__device__ __host__ static inline IData VL_GTES_IQQ(int, int lbits, int, QData lhs,
                                                    QData rhs) VL_PURE {
    vlsint64_t lhs_signed = VL_EXTENDS_QQ(64, lbits, lhs);
    vlsint64_t rhs_signed = VL_EXTENDS_QQ(64, lbits, rhs);
    return lhs_signed >= rhs_signed;
...
__device__ __host__ static inline IData VL_LTS_III(int, int lbits, int, IData lhs,
                                                   IData rhs) VL_PURE {
    vlsint64_t lhs_signed = VL_EXTENDS_QQ(64, lbits, lhs);  // Q for gcc
    vlsint64_t rhs_signed = VL_EXTENDS_QQ(64, lbits, rhs);  // Q for gcc
    return lhs_signed < rhs_signed;
...
__device__ __host__ static inline IData VL_LTS_IQQ(int, int lbits, int, QData lhs,
                                                   QData rhs) VL_PURE {
    vlsint64_t lhs_signed = VL_EXTENDS_QQ(64, lbits, lhs);
    vlsint64_t rhs_signed = VL_EXTENDS_QQ(64, lbits, rhs);
    return lhs_signed < rhs_signed;
...
__device__ __host__ static inline IData VL_LTES_III(int, int lbits, int, IData lhs,
                                                    IData rhs) VL_PURE {
    vlsint64_t lhs_signed = VL_EXTENDS_QQ(64, lbits, lhs);  // Q for gcc
    vlsint64_t rhs_signed = VL_EXTENDS_QQ(64, lbits, rhs);  // Q for gcc
    return lhs_signed <= rhs_signed;
...
// Important: Unlike most other funcs, the shift might well be a computed
// expression.  Thus consider this when optimizing.  (And perhaps have 2 funcs?)
__device__ __host__ static inline WDataOutP VL_SHIFTR_WWI(int obits, int, int, WDataOutP owp,
                                                          WDataInP lwp, IData rd) VL_MT_SAFE {
